...
/*    this.cameraConnectionCallback = connectionCallback;
  ...
  public static CameraConnectionFragment newInstance(
      final int layout,
      final Size inputSize) {
    return new CameraConnectionFragment(layout, inputSize);
  }
  ...
  public void getResult(interfaceCallback callback){
    callback.getResult("hello world");
  ...
  public View onCreateView(
    ...
    return inflater.inflate(R.layout.camera_connection_fragment, null);
  }
